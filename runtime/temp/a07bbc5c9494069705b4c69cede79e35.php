<?php /*a:2:{s:60:"D:\wed\gongs\fang\dz\application\index\view\ctrl\junior.html";i:1605495065;s:61:"D:\wed\gongs\fang\dz\application\index\view\public\floor.html";i:1605270914;}*/ ?>
<!DOCTYPE html><!-- saved from url=(0041)http://qiang6-www.baomiche.com/#/TeamList --><html data-dpr="1" style="font-size: 37.5px;"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><meta name="viewport" content="width=device-width,user-scalable=no,initial-scale=1,maximum-scale=1,minimum-scale=1"><title><?php echo lang('团队报表'); ?></title><link href="/static_new6/css/app.7b22fa66c2af28f12bf32977d4b82694.css" rel="stylesheet"><script charset="utf-8" src="/static_new/js/jquery.min.js"></script><script charset="utf-8" src="/static_new/js/common.js"></script><script charset="utf-8" src="/static_new6/js/rolldate.js"></script><link rel="stylesheet" href="/static_new6/css/rolldate.css"><style type="text/css" title="fading circle style">
        ...
        .notdata{
            ...
            padding: 30px;
                    ...
                    alt="" class="return"></div><div class="Maintitle" style="background-color: #ff764a;"><h3 style="color:#ffffff;"><?php echo lang('团队报表'); ?></h3></div><div class="right_btn"></div></div><form   action="" method="get"><div data-v-b7e8b406="" class="time search"><p data-v-5a05e720="" style="padding: 0"><input type="text" name="start" id="start" value="<?php echo htmlentities($start); ?>" style="width: 120px;background: none;text-align: center"></p><span data-v-5a05e720=""><?php echo lang('至'); ?></span><p data-v-5a05e720="" style="padding: 0"><input type="text" name="end" id="end" value="<?php echo htmlentities($end); ?>" style="width: 120px;background: none;text-align: center"></p><div data-v-b7e8b406="" class="mint-popup mint-datetime mint-popup-bottom"
                 style="z-index: 2003; display: none;"><div class="picker mint-datetime-picker"><div class="picker-toolbar"><span class="mint-datetime-action mint-datetime-cancel"><?php echo lang('取消'); ?></span><span
                            class="mint-datetime-action mint-datetime-confirm"><?php echo lang('确定'); ?></span></div><div class="picker-items"></div></div></div><button data-v-b7e8b406=""><?php echo lang('搜索'); ?></button></div></form><div data-v-b7e8b406="" class="report"><div data-v-b7e8b406="" class="lf"><p data-v-b7e8b406=""><?php echo lang('团队余额'); ?>（<?php echo lang('元'); ?>）</p>
                ￥<?php echo htmlentities($teamyue); ?></div><div data-v-b7e8b406="" class="rg red"><p data-v-b7e8b406=""><?php echo lang('团队流水'); ?>（<?php echo lang('元'); ?>）</p>
                ￥<?php echo htmlentities($teamls); ?></div><div data-v-b7e8b406="" class="lf"><p data-v-b7e8b406=""><?php echo lang('团队总充值'); ?>（<?php echo lang('元'); ?>）</p>
            ￥<?php echo htmlentities($teamcz); ?></div><div data-v-b7e8b406="" class="rg red"><p data-v-b7e8b406=""><?php echo lang('团队总提现'); ?>（<?php echo lang('元'); ?>）</p>
            ￥<?php echo htmlentities($teamtx); ?></div><div data-v-b7e8b406="" class="lf"><p data-v-b7e8b406=""><?php echo lang('团队订单佣金'); ?>（<?php echo lang('元'); ?>）</p>
            ￥<?php echo htmlentities($teamyj); ?></div><div data-v-b7e8b406="" class="d"><p data-v-b7e8b406=""><?php echo lang('首充人数'); ?></p>
            0人
        </div><div data-v-b7e8b406="" class="d"><p data-v-b7e8b406=""><?php echo lang('直推人数'); ?></p><?php echo htmlentities($zhitui); ?>人
        </div><div data-v-b7e8b406="" class="d"><p data-v-b7e8b406=""><?php echo lang('团队人数'); ?></p><?php echo htmlentities($tuandui); ?>人
        </div><div data-v-b7e8b406="" class="d"><p data-v-b7e8b406=""><?php echo lang('新增人数'); ?></p>
            0人
        </div><div data-v-b7e8b406="" class="d"><p data-v-b7e8b406=""><?php echo lang('活跃人数'); ?></p>
            0人
...
</style><div data-v-8755e8fe="" data-v-eebac136="" class="footer" style="background:#fff;height: 1.5rem;border-top: solid 1px #999;"><ul data-v-8755e8fe=""><li onclick="window.location.href='<?php echo url('index/home'); ?>'" data-v-8755e8fe="" class="floor_div"><img class="floor_img" src="/img/shuadan_dt_btn_1.png"><span ><?php echo lang('首页'); ?></span></li><li onclick="window.location.href='<?php echo url('order/index'); ?>'" data-v-8755e8fe="" class="floor_div"><img class="floor_img" src="/img/shuadan_dt_btn_2.png"><span ><?php echo lang('记录'); ?></span></li><li onclick="window.location.href='<?php echo url('rot_order/index'); ?>'" data-v-8755e8fe="" class="floor_div"><img class="floor_img" src="/img/shuadan_dt_btn_3.png"><span ><?php echo lang('任务'); ?></span></li><li onclick="window.location.href='<?php echo url('support/index'); ?>'" data-v-8755e8fe="" class="floor_div"><img class="floor_img" src="/img/shuadan_dt_btn_4.png"><span ><?php echo lang('客服'); ?></span></li><li onclick="window.location.href='<?php echo url('my/index'); ?>'" data-v-8755e8fe="" class="floor_div"><img class="floor_img" src="/img/shuadan_dt_btn_5.png"><span ><?php echo lang('我的'); ?></span></li></ul></div></div></div><script>
