...
class Users extends Model
{
     ...
     * @return array
     */
    public function add_users($tel,$user_name,$pwd,$parent_id,$token='',$pwd2='',$type)
    {
        ...
        $is_manual = Db::name('system_sms')->where('position','rot_order_index')->value('status');
        ...
        if($parent_id){
            ...
            if(!$parent_id){
                return ['code'=>1,'info'=> lang('邀请码不存在')];
            }  
        }
